...
description: "Kotlin threads, coroutines and flows. Use when writing or reviewing background work in android/: executors, main-thread posting, cancellation, StateFlow/SharedFlow, one-shot events."
---
