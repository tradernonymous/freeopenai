---
name: owasp-security
description: "Web and AI security review (OWASP Top 10, LLM Top 10). Use when changing auth, cookies, sessions, login, SSRF-prone fetches (web_fetch, image URLs), provider proxying, file handling, or anything that takes user input on the server."
---

> **freeopenai notes:** focus on JavaScript (server.js, auth.js, github.js, provider routing) and Kotlin (android/). Secrets live only in Railway and GitHub secrets; never print their values.
