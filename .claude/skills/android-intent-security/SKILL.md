...
description: "Android intent and component security. Use when touching AndroidManifest.xml, exported activities/services/receivers, intent filters (share, PROCESS_TEXT, shortcuts, QS tile), PendingIntent, or code reading intent extras."
...
> **freeopenai notes:** WebView security (WebShell.kt, WebActivity, PuterImages) is not covered here: check it by hand (no JS bridge, origin checks, no file access).
