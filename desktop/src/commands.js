...
(function (root, factory) {
  ...
  var COMMANDS = [
    ...
    { id: 'go-design', group: 'Go to', title: 'Design', hint: 'Brand + anti-slop review', keys: 'Alt+4', palette: 'design' },
    { id: 'go-library', group: 'Go to', title: 'Library', hint: 'Skills and saved chats', keys: 'Alt+5', palette: 'library' },
    { id: 'go-files', group: 'Go to', title: 'Files', hint: 'Extract and generate documents', keys: 'Alt+F', palette: 'files' },
    { id: 'go-settings', group: 'Go to', title: 'Settings', hint: 'Engine, sign-in, diagnostics', keys: 'Alt+6', palette: 'settings' },
    ...
    { id: 'toggle-files', group: 'Panel', title: 'Workspace files', hint: 'The engine workspace tree' },
    { id: 'toggle-terminal', group: 'Panel', title: 'Terminal', hint: 'Run commands on the engine' },
