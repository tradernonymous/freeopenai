...
- **Side drawer:** search, **New chat** and **Library**, then pinned chats and history grouped by day. Swipe in from the left edge to open it. Long-press a chat to pin, rename, share, archive or delete it, or swipe a row left to archive it directly. An **Archived** row appears once you have any, and expands to show them; archiving keeps a chat's data and search hit, unlike delete. Your account row opens **Settings**.
